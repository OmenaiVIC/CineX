...
async function runMigrations() {
  ...
  try {
    ...
    const files = ['001_initial.sql', '002_campaigns.sql', '003_milestone_votes.sql', '004_auth.sql', '005_contact.sql', '006_bos_schema.sql', '007_bos_monitoring.sql', '008_relay_sponsorship.sql', '009_payout_gates.sql', '010_bos_e2e.sql'];
