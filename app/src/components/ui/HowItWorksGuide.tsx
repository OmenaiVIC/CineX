...
const STEPS: Step[] = [
  {
    ...
    icon: '◆',
    description: 'Connect your Stacks wallet or sign up with email to join CineX. Your wallet address becomes your identity on the platform — no passwords, no KYC friction.',
    points: [
      'Connect any Stacks wallet (Leather, Xverse, etc.)',
      'No gas fees for account creation',
      'Your address is your profile ID',
  ...
  },
  {
    ...
    points: [
      'Backers contribute with STX, USD, or NGN',
      'Funds held in smart contract escrow',
      'Idle capital earns DeFi yield automatically',
  ...
  },
  {
    ...
    points: [
      ...
      'Full project history recorded on-chain',
    ],
  },
];
